...
enum {
    small_asteroid_width = 4,
    small_asteroid_height = 3,
    medium_asteroid_width = 6,
    medium_asteroid_height = 4,
    big_asteroid_width = 10,
    big_asteroid_height = 7
};
...
enum { small_asteroid_hp = 1, medium_asteroid_hp = 2, big_asteroid_hp = 4 };
...
static const char small_asteroid_shape[small_asteroid_height]
[small_asteroid_width + 1] = {
    " ** ", "****", " ** "};
...
static asteroid_data small_asteroid_data = {small,
    small_asteroid_width,
    small_asteroid_height,
    small_asteroid_hp,
    small_asteroid_damage,
    small_asteroid_movement_frames,
    small_asteroid_score_for_kill,
    small_asteroid_score_for_kill};

static asteroid_data medium_asteroid_data = {medium,
    medium_asteroid_width,
    medium_asteroid_height,
    medium_asteroid_hp,
    medium_asteroid_damage,
    medium_asteroid_movement_frames,
    medium_asteroid_score_for_kill,
    medium_asteroid_score_for_kill};

static asteroid_data big_asteroid_data = {big,
    big_asteroid_width,
    big_asteroid_height,
    big_asteroid_hp,
    big_asteroid_damage,
    big_asteroid_movement_frames,
    big_asteroid_score_for_kill,
    big_asteroid_score_for_kill};
...
void init_asteroid_static_data() {
    small_asteroid_data.score_for_skip =
        (int)(small_asteroid_data.score_for_kill * SCORE_FOR_SKIP_COEFF);
    medium_asteroid_data.score_for_skip =
        (int)(medium_asteroid_data.score_for_kill * SCORE_FOR_SKIP_COEFF);
    big_asteroid_data.score_for_skip =
        (int)(big_asteroid_data.score_for_kill * SCORE_FOR_SKIP_COEFF);
}
...
#define CHECK_POINT_IN_ASTEROID(ARR, AST, P)                                   \
    loc_x = P.x - AST->pos.x;                                                    \
    loc_y = P.y - AST->pos.y;                                                    \
    if (loc_x < 0 || loc_x >= AST->data->width || loc_y < 0 ||                   \
            loc_y >= AST->data->height)                                              \
    return 0;                                                                  \
    else                                                                         \
